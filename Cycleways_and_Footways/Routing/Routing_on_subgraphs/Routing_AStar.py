...
def main(args=None):
    ...
    if options.weight == "cost":
        ...
        """Generation of the map with the obtained paths displayed"""
        creation_map_travel_time(result_routing_travel_time, nodes, gdf_cycleways, gdf_footways, path,
                           options.lat, options.lon, options.mapName)
        print("Creation of the map with the two paths drawn on it : done ")
        ...
        """Routing considering as weight the travel time"""
        result_routing_travel_time = greeter.routing_algorithm_based_on_travel_time(options.lat, options.lon,
                                                                                    options.dest,
